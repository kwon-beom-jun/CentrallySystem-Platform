...
public interface InfoPostRepository extends JpaRepository<InfoPost, Long> {
     ...
     */
    @Query("SELECT new com.cs.info.dto.InfoPostListDto(" +
    ...
    Page<InfoPostListDto> findAllForListByBoardId(@Param("boardId") Long boardId, Pageable pageable);
    ...
    Page<InfoPostListDto> findAllForList(Pageable pageable);
    ...
    Page<InfoPostListDto> findAllForListByBoardIdAndVisibilityScope(
