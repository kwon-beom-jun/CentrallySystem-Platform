...
sequenceDiagram
    ...
    Auth->>Auth: 권한 조회
    alt 권한 없음
        Auth-->>Frontend: InsufficientAuthenticationException<br/>"부여된 권한이 없습니다"
...
권한 변경 후 Refresh Token으로 새 Access Token을 발급받으면, 최신 권한 정보가 반영됩니다.
...
sequenceDiagram
    ...
    alt 권한 없음
        Auth-->>Frontend: InsufficientAuthenticationException<br/>"권한이 없습니다"
