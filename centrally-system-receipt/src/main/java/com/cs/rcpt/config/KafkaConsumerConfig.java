...
public class KafkaConsumerConfig {
    ...
    // RECEIPT 그룹 전용 ConsumerFactory
    @Bean
    public DefaultKafkaConsumerFactory<String, Object> consumerFactoryReceipt() {
        return new DefaultKafkaConsumerFactory<>(createConsumerConfigs(Group.RECEIPT_GROUP));
    }

    // RECEIPT 그룹 전용 KafkaListenerContainerFactory
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerContainerFactoryReceipt() {
        ConcurrentKafkaListenerContainerFactory<String, Object> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerFactoryReceipt());
