<template>
  <div class="content content-wrapper">
    ...
    <div class="info-box">
      ...
      <span>{{ $t('hrm.favoriteMenu.info') }}</span>
    </div>
...
@media (max-width: 650px) {
  ...
  .info-box span {
    display: inline-flex;     /* 텍스트 컨테이너를 플렉스로 */
    align-items: center;      /* 글리프를 수직 가운데 정렬 */
    line-height: 1;           /* 위아래 여백(leading) 제거 → 정확한 중앙감 */
  }
  /* 아이콘도 기준선/라인높이 영향 제거(옵션) */
  .info-box i {
    display: inline-flex;
    align-items: center;
    line-height: 1.3;
