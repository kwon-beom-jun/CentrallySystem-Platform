    ...
    <div class="modal-body">
      ...
      <form @submit.prevent="openConfirmationModal" @keydown.enter.prevent>
        ...
        <div v-if="favoriteApprovers.length && showFavorites" class="favorite-approvers-area cs-card--blue">
            ...
            <template #item="{ element: fav }">
              <li class="list-group-item d-flex align-items-center justify-content-between">
                ...
                <div>
                  ...
                  <DefaultSmallButton variant="secondary"
          ...
          <DefaultButton color="blue" @click="saveFavoriteOrder" customHeight="25px" align="right" marginTop="5px">{{ $t('hrm.favoriteMenu.orderSaveSuccess') }}</DefaultButton>
        </div>
        </transition>
