  ...
  <header class="navbar">
    <div class="navbar-inner">
      ...
      <RouterLink :to='ROUTES.MAIN' class="logo" @click="handleLogoClick">
        ...
        <img class="logo-desktop" src="/img/common/logo/centrally-logo.png" alt="logo" />
        <img class="logo-mobile"  src="/img/common/logo/centrally-logo2.png" alt="logo-mobile" />
        <img class="logo-compact" src="/img/common/logo/centrally_logo_4.png" alt="logo-compact" />
      </RouterLink>
      ...
      <div class="user-box">
        ...
        <!-- 프로필 -->
        <RouterLink :to="ROUTES.USER.USER_INFORMATION" class="icon-btn" @click="handleLogoClick">
          <template v-if="authStore.getUserProfileImgUrl">
            <img :src="authStore.getUserProfileImgUrl" alt="profile" class="header-avatar" />
          </template>
          <template v-else>
