...
//import com.cs.auth.util.rest.hrm.HrmUserClient;
...
public class AuthUserService {
    ...
    public void createUser(AuthJoinRequest request) {
        ...
        // 기능: 회원 가입 처리
        // - 이메일 중복 체크
        // - 비밀번호 인코딩 (또는 이미 인코딩된 비밀번호 사용)
        // - AuthUser 엔티티 생성 및 저장
        // - 가입 이벤트 Outbox 기록 (Kafka 이벤트 발행 준비)
...
//            user.setPassword(passwordEncoder.encode(pw));
        ...
        // 포트폴리오용 - 구현 제거됨 (사용자 활성화 변경 이벤트 Outbox 기록)
        if (enabledChanged) {
            // AuthUserEnabledChangedEvent 생성 및 Outbox 기록
        }
    }
    ...
    public void deleteUser(Integer id) {
        ...
        // 포트폴리오용 - 구현 제거됨 (사용자 삭제 이벤트 Outbox 기록)
        // AuthUserDeletedEvent 생성 및 Outbox 기록
    }
